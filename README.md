...
## Installation
Download the latest version from releases, the name should look something like this: ``networx-0.0.0.zip``, extract it and run ``bundle`` in the extracted folder, then run ``ruby install.rb``. Please note Windows users must add the install to their PATH manually.
